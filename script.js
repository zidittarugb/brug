...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const startMessage = "click anywhere !!";
  ...
  const bioMessages = [
    "hi there !!!",
    "ignore the view results and the obviously fake view counter, i gave up trying to delete them",
    "\"i got bored so i learned how to edit code lmao\""
  ];
  let bioText = '';
  let bioIndex = 0;
    ...
    if (!isShowingSkills) {
      gsap.to(profileBlock, {
        ...
        onComplete: () => {
          ...
          gsap.to(sigmaBar, { width: '47%', duration: 2, ease: 'power2.out' });
          gsap.to(alphaBar, { width: '47%', duration: 2, ease: 'power2.out' });
          gsap.to(gyatBar, { width: '47%', duration: 2, ease: 'power2.out' });
        }
      });
    ...
    if (!isShowingSkills) {
      gsap.to(profileBlock, {
        ...
        onComplete: () => {
          ...
          gsap.to(sigmanBar, { width: '47%', duration: 2, ease: 'power2.out' });
          gsap.to(alphaBar, { width: '47%', duration: 2, ease: 'power2.out' });
          gsap.to(gyatBar, { width: '47%', duration: 2, ease: 'power2.out' });
        }
      });
